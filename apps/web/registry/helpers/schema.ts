...
export const availableRegistryItemTypeSchema = z.union([
  z.literal(HELPER_REGISTRY_ITEM_TYPE__UTIL),
  z.literal(HELPER_REGISTRY_ITEM_TYPE__TYPE),
  z.literal(HELPER_REGISTRY_ITEM_TYPE__CONSTANT),
  z.literal(HELPER_REGISTRY_ITEM_TYPE__GLOBAL_CSS),

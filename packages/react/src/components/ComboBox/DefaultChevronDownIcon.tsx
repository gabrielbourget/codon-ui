type TComboBoxDefaultChevronDownIconProps = {
  size?: number
  color?: string
  customClassName?: string
}

const ComboBoxDefaultChevronDownIcon = (props: TComboBoxDefaultChevronDownIconProps) => {
...
export default ComboBoxDefaultChevronDownIcon

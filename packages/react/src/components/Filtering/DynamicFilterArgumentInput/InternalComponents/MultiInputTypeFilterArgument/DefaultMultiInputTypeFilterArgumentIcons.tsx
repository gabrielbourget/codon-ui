type TMultiInputTypeFilterArgumentDefaultIconProps = {
  size?: number
  color?: string
...
const buildDefaultIconProps = (props: TMultiInputTypeFilterArgumentDefaultIconProps) => {
...
export const MultiInputTypeFilterArgumentDefaultAddIcon = (props: TMultiInputTypeFilterArgumentDefaultIconProps) => {
...
export const MultiInputTypeFilterArgumentDefaultDeleteIcon = (props: TMultiInputTypeFilterArgumentDefaultIconProps) => {
  const { interpretedProps, customClassName } = buildDefaultIconProps(props)

...
type TCompactTypeaheadSearchDefaultLoadingIndicatorProps = {
  size?: number | string
  spinnerColor?: string
...
const CompactTypeaheadSearchDefaultLoadingIndicator = (props: TCompactTypeaheadSearchDefaultLoadingIndicatorProps) => {
  const {
    size = 18,
...
export default CompactTypeaheadSearchDefaultLoadingIndicator

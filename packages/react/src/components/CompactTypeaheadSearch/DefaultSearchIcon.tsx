type TCompactTypeaheadSearchDefaultSearchIconProps = {
  size?: number
  color?: string
...
const CompactTypeaheadSearchDefaultSearchIcon = (props: TCompactTypeaheadSearchDefaultSearchIconProps) => {
...
export default CompactTypeaheadSearchDefaultSearchIcon

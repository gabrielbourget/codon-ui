...
const buildDefaultIconProps = (props: TToastDefaultIconProps) => {
...
export const ToastDefaultCheckmarkIcon = (props: TToastDefaultIconProps) => {
...
export const ToastDefaultCircleInfoIcon = (props: TToastDefaultIconProps) => {
  ...
  return (
    <svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" className={customClassName} {...interpretedProps}>
      ...
      <path d="M16.47 7.5c1.12 0 1.95.79 1.94 1.79-.01.75-.56 1.4-1.37 1.62-.9.25-1.9-.16-2.28-.93-.55-1.09.22-2.35 1.51-2.48.08 0 .16 0 .21-.01z" />
    </svg>
  )
}

export const ToastDefaultCloseIcon = (props: TToastDefaultIconProps) => {
  const { interpretedProps, customClassName } = buildDefaultIconProps(props)
...
export const ToastDefaultDeleteIcon = (props: TToastDefaultIconProps) => {
  const { interpretedProps, customClassName } = buildDefaultIconProps(props)
...
export const ToastDefaultErrorIcon = (props: TToastDefaultIconProps) => {
  const { interpretedProps, customClassName } = buildDefaultIconProps(props)
...
export const ToastDefaultOctagonExclamationIcon = (props: TToastDefaultIconProps) => {
  const { interpretedProps, customClassName } = buildDefaultIconProps(props)
...
export const ToastDefaultTriangleExclamationIcon = (props: TToastDefaultIconProps) => {
  const { interpretedProps, customClassName } = buildDefaultIconProps(props)

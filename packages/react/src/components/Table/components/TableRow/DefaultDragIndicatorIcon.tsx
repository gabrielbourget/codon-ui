type TTableRowDefaultDragIndicatorIconProps = {
  size?: number
  color?: string
...
const TableRowDefaultDragIndicatorIcon = (props: TTableRowDefaultDragIndicatorIconProps) => {
...
export default TableRowDefaultDragIndicatorIcon

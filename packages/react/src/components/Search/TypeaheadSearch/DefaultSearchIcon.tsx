type TTypeaheadSearchDefaultSearchIconProps = {
  size?: number
  color?: string
...
const TypeaheadSearchDefaultSearchIcon = (props: TTypeaheadSearchDefaultSearchIconProps) => {
...
export default TypeaheadSearchDefaultSearchIcon

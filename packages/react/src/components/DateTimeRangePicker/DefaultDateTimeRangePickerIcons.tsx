type TDateTimeRangePickerDefaultIconProps = {
  size?: number
  color?: string
...
export const DateTimeRangePickerDefaultCalendarIcon = (props: TDateTimeRangePickerDefaultIconProps) => {
...
export const DateTimeRangePickerDefaultChevronLeftIcon = (props: TDateTimeRangePickerDefaultIconProps) => {
  const { size, color, customClassName } = props
  const interpretedProps: Record<string, string | number> = {}
...
export const DateTimeRangePickerDefaultChevronRightIcon = (props: TDateTimeRangePickerDefaultIconProps) => {
  const { size, color, customClassName } = props
  const interpretedProps: Record<string, string | number> = {}

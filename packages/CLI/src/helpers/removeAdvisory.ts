...
export const REMOVE_ADVISORY_DEPENDENCY_CLEANUP_ACTION__CLEANUP_CANDIDATE = "cleanup-candidate"
export const REMOVE_ADVISORY_DEPENDENCY_CLEANUP_ACTION__STILL_REQUIRED = "still-required"
export const REMOVE_ADVISORY_DEPENDENCY_CLEANUP_ACTION__UNKNOWN = "unknown"

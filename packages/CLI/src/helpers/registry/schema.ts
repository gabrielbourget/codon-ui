...
export const availableHelperRegistryItemTypeSchema = z.union([
  z.literal(REGISTRY_ITEM_TYPE__COMPONENT),
  z.literal(REGISTRY_ITEM_TYPE__ICON),
  z.literal(REGISTRY_ITEM_TYPE__UTIL),
  z.literal(REGISTRY_ITEM_TYPE__CONSTANT),
  z.literal(REGISTRY_ITEM_TYPE__TYPE),
  z.literal(REGISTRY_ITEM_TYPE__GLOBAL_CSS),
...
export const registryIndexItemDirectorySchema: ZodType<TRegistryIndexItemDirectory> = z.lazy(() =>
  z.object({
    name: z.string(),
    content: z.array(z.union([componentRegistryIndexItemFileSchema, registryIndexItemDirectorySchema])),
  }),
)
